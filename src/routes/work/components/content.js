...
const dbvProject = () => (
    <div className="project text-box floating-box">
        ...
        <p>The dbv-c was designed to solve many problems that occur in a most of the training system. Some of the primary issues required to be addressed are listed below.</p>
        <ul>
...
export const content = (props) => (
    <div className="work-content section-content col-xs-12">
